...
class SpriteManager(QLabel):
    def __init__(self, manager):
        ...
        self.sprites = {}
        self.sprite_data = [
            ["src/images/cat_sit_f.png", 4, 500],
            ["src/images/cat_walk_b.png", 3, 300],
            ["src/images/cat_walk_f.png", 3, 300],
            ["src/images/cat_walk_l.png", 6, 150],
            ["src/images/cat_walk_r.png", 6, 150]]
